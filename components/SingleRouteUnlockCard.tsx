...
export default function SingleRouteUnlockCard({ route }: { route: ThemeRoute }) {
  return (
    <div className="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">
      ...
      <div className="mt-3 w-full rounded-full bg-white py-2 text-center text-sm font-semibold text-slate-900">
        單次解鎖
      </div>
    </div>
  );
